  ...
  return (
    <section className="px-8 pt-20 " id="about">
      ...
      <div className="wrapper">
        ...
        <br></br>
        <p className="text-neutral-100 justify-left text-2xl font-normal leading-tight dark:text-zinc-800 ">
        ...
        <p className="text-neutral-100 justify-left mt-3 text-2xl font-normal leading-tight dark:text-zinc-800">
        ...
        <p className="justify-left text-neutral-100 mt-4 text-2xl font-normal leading-tight dark:text-zinc-800">
