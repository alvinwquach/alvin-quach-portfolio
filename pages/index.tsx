        ...
        <section className="px-8 pt-20 " id="about">
          ...
          <div className="wrapper">
            ...
            <p className="text-neutral-100 justify-left text-2xl font-normal leading-tight">
              ...
              developer. Prior to web development, I was in Marketing and that's
              where I fell in love with storytelling. I hope to tell more
              stories through accessible code. Here's my{' '}
              <a
